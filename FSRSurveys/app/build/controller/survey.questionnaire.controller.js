...
(function (survey) {
    var QuestionnaireController = (function (_super) {
        ...
        QuestionnaireController.prototype.populateQuestionnaire = function () {
            var _this = this;
            this.cache.questionnaireData = new Array();
            this.surveyService.resolveCategories().then(function (response) {
                var categories = response;
                for (var _i = 0, categories_1 = categories; _i < categories_1.length; _i++) {
                    var category = categories_1[_i];
                    _this.cache.questionnaireData.push(new survey.QuestionnaireItem(category, new survey.Answer()));
                }
                _this.cache.questionnaireData.push(new survey.QuestionnaireItem(new survey.Category(0, "Other", ""), new survey.Answer()));
            });
        };
        QuestionnaireController.prototype.calculateTotals = function () {
            var _this = this;
            var currentController = this;
            this.$scope.$watch(function () { return _this.cache.questionnaireData; }, function (newValue, oldValue) {
